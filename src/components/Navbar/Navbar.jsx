    ...
    return (
        <>
            <nav className='pt-[15px] pb-4 shadow-navShadow fixed w-full z-10'>
                <div className='max-w-container mx-auto flex items-center px-3'>
                    ...
                    <div className={`navToggle md:ml-auto md:static absolute top-full pb-4 md:pb-0 w-full md:w-max duration-500 bg-navItems md:bg-inherit ${navItemShow ? "right-0" : "right-[-100%]"
                        ...
                        <div className='md:flex items-center px-6 md:px-0'>
                            <ul className='md:flex'>
                                <li className='mb-1.5 md:mb-0 tablet:py-1 md:py-0'><a className='font-raleway text-base tablet:text-lg lg:text-base font-extrabold text-[#817382] mr-12 hover:text-primary duration-300' href="#">Home</a></li>
                                <li className='mb-1.5 md:mb-0 tablet:py-1 md:py-0'><a className='font-raleway text-base tablet:text-lg lg:text-base font-extrabold text-[#817382] mr-12 hover:text-primary duration-300' href="#">Our services</a></li>
                                <li className='mb-1.5 md:mb-0 tablet:py-1 md:py-0'><a className='font-raleway text-base tablet:text-lg lg:text-base font-extrabold text-[#817382] mr-12 hover:text-primary duration-300' href="#">About Us</a></li>
                                <li className='mb-1.5 md:mb-0 tablet:py-1 md:py-0'><a className='font-raleway text-base tablet:text-lg lg:text-base font-extrabold text-[#817382] mr-12 hover:text-primary duration-300' href="#">What’s new?</a></li>
                            </ul>
                    ...
                    <div onClick={handleOpen} className='ml-auto md:ml-0 block md:hidden px-2 py-2 bg-[#FFE4D9] rounded-[5px] text-xl tablet:test-2xl text-primary hover:text-white hover:bg-primary duration-500 ease-liner cursor-pointer'><FaBars /></div>
