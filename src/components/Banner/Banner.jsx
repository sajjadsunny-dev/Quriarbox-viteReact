    ...
    return (
        <>
            <section className='h-screen'>
                <div className='max-w-container mx-auto px-3 h-full flex items-center md:items-end relative'>
                    <div className='md:pb-44'>
                        <h1 className='font-raleway font-regular text-[#261134] text-4xl tablet:text-5xl md:w-[470px]'>A trusted provider of <br></br><span className='leading-[120%] font-extrabold'>courier services.</span></h1>
