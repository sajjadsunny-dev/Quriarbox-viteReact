        ...
        <>
            <section>
                <div className="max-w-container m-auto">
                    <div className='w-[872px] mx-auto grid grid-cols-2 gap-6'>
                        <div className='pb-[31px]'>
                            <img src={formIlustrator} alt="formIlustrator" />
                            <h3 className='font-oxanium text-2xl font-bold text-primary mt-[13px]'>REQUEST A CALLBACK</h3>
                            <h2 className='font-raleway text-[39px] font-extrabold text-[#222132] mb-[9px] mt-5 leading-[110%]'>We will contact in the shortest time.</h2>
                            <p className='font-raleway text-[25px] font-semibold text-[#9291A1] leading-[120%]'>Monday to Friday, 9am-5pm.</p>
                        </div>
                        <div className=''>
                            <form className='h-full flex flex-col justify-center'>
                                ...
                                <textarea className='h-[154px] focus:outline-none py-[15px] pl-[19px] font-raleway text-base text-regular leading-[120%] text-[#9291A1] border-[1px] border-[#C5C5D2] resize-none focus:border-[#C5C5D2] focus:border-2 rounded-[8px] mb-[54px]' type="text" placeholder='Message'></textarea>
